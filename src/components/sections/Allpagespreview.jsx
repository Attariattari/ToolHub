...
const ResizableTextElement = ({
  ...
  return (
    <>
      ...
      <div
        ref={elementRef}
        className={`absolute text-element select-none ${isSelected ? "ring-2 ring-red-400 ring-opacity-60" : ""
          } ${isDragging
            ? "cursor-grabbing"
...
const ResizableImageElement = ({
  ...
  return (
    <>
      ...
      <div
        ref={elementRef}
        className={`absolute image-element select-none ${isSelected ? "ring-2 ring-red-500 ring-opacity-60" : ""
          } ${isDragging
            ? "cursor-grabbing"
            : isSelected
              ? "cursor-grab"
...
const DrawElement = ({
  ...
  const generateBrushPath = (points, smooth = true) => {
    ...
    if (points.length === 1) {
      return `M ${points[0].x} ${points[0].y} A 0.5 0.5 0 1 1 ${points[0].x + 0.1
        } ${points[0].y}`;
    }
                  ...
                  {Array.from({ length: numPages }, (_, i) => i + 1).map(
                    (pageNum) => (
                      <button
                        ...
                        className={`w-2 h-2 rounded-full transition-all duration-200 ${pageNum === currentPage
                            ? "bg-red-600 w-6"
              ...
              {pageGroups.map(([leftPage, rightPage], groupIndex) => (
                ...
                >
                  ...
                  <div className="flex-shrink-0" data-page-number={leftPage}>
                    <div
                      className={`transition-all duration-300 hover:ring-red-100 hover:ring-4 hover:ring-offset-2 relative ${currentPage === leftPage
                  ...
                  {rightPage && (
                    <div className="flex-shrink-0" data-page-number={rightPage}>
                      <div
                        className={`transition-all duration-300 hover:ring-red-100 hover:ring-4 hover:ring-offset-2 relative ${currentPage === rightPage
                            ? "ring-2 ring-red-600 ring-offset-2"
                            : ""
                          }`}
                        style={{ transformOrigin: "top left" }}
              ...
              {Array.from({ length: numPages }, (_, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="w-fit">
                      <div
                        className={`transition-all duration-300 hover:ring-red-100 hover:ring-4 hover:ring-offset-2 relative ${isCurrentPage
                            ? "ring-2 ring-red-600 ring-offset-2"
                            : ""
                          }`}
                        style={{ transformOrigin: "top left" }}
