                ...
                <div className="py-1">
                  {layoutOptions.map((option) => (
                    <button
                      ...
                      className={`w-full px-3 py-2 flex items-center gap-3 hover:bg-gray-50 transition-colors text-left ${currentLayout === option.id
              ...
              <div className="flex items-center gap-1">
                ...
                {[50, 100, 150, 200].map((level) => (
                  <button
                    ...
                    className={`px-2 py-1 text-xs rounded transition-colors ${zoom === level
