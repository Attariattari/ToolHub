...
export default function Hero() {
  return (
    <section className="relative overflow-hidden py-8 lg:py-20">
      <div className="absolute inset-0 bg-gradient-to-r from-blue-100 to-sky-100"></div>
      ...
      <div className="absolute top-1/4 right-1/4 w-24 h-24 bg-blue-300/5 rounded-full blur-xl"></div>
      <div className="absolute bottom-1/3 left-1/4 w-32 h-32 bg-sky-300/5 rounded-full blur-xl"></div>

      <div className="absolute top-20 right-[20%] w-3 h-3 bg-blue-500/20 rounded-full animate-pulse"></div>
      <div className="absolute top-40 left-[15%] w-2 h-2 bg-sky-500/20 rounded-full animate-pulse delay-700"></div>
      <div className="absolute bottom-20 right-[30%] w-4 h-4 bg-blue-400/15 rounded-full animate-pulse delay-1000"></div>

      <svg className="absolute top-0 right-0 opacity-5" width="400" height="400" viewBox="0 0 400 400" fill="none">
        <circle cx="200" cy="200" r="150" stroke="rgba(37, 99, 235, 0.3)" strokeWidth="2" strokeDasharray="8 8" />
        <circle cx="200" cy="200" r="100" stroke="rgba(37, 99, 235, 0.2)" strokeWidth="2" />
      </svg>

      <svg className="absolute bottom-0 left-0 opacity-5" width="300" height="300" viewBox="0 0 300 300" fill="none">
        <circle cx="150" cy="150" r="100" stroke="rgba(14, 165, 233, 0.3)" strokeWidth="2" strokeDasharray="12 12" />
        <circle cx="150" cy="150" r="50" stroke="rgba(14, 165, 233, 0.2)" strokeWidth="2" />
      </svg>
      ...
      >
        <circle cx="200" cy="200" r="200" fill="rgba(37, 99, 235, 0.14)" />
        <circle cx="200" cy="200" r="150" fill="rgba(37, 99, 235, 0.08)" />
        <circle cx="200" cy="200" r="100" fill="rgba(37, 99, 235, 0.06)" />
      </svg>
      ...
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
      >
        <circle cx="175" cy="175" r="175" fill="rgba(6, 182, 212, 0.14)" />
        <circle cx="175" cy="175" r="120" fill="rgba(6, 182, 212, 0.08)" />
        <circle cx="175" cy="175" r="80" fill="rgba(6, 182, 212, 0.06)" />
      </svg>
      ...
      <svg
        ...
        fill="none"
      >
        <line x1="0" y1="1" x2="1200" y2="1" stroke="rgba(37, 99, 235, 0.5)" strokeWidth="2" strokeDasharray="12 8" />
      </svg>
      ...
      <svg
        ...
        fill="none"
      >
        <line x1="0" y1="1" x2="1200" y2="1" stroke="rgba(6, 182, 212, 0.9)" strokeWidth="2" strokeDasharray="8 12" />
      </svg>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-center">
          <div className="lg:col-span-3">
            ...
            >
              ...
              <span className="bg-gradient-to-r from-blue-600 to-sky-600 bg-clip-text text-transparent">one place</span>
            </h1>
            ...
            >
              <a
                href="#tools"
                className="bg-gradient-to-r from-blue-600 to-blue-700 text-white px-8 py-2.5 text-center w-full sm:w-auto rounded-full text-lg font-semibold shadow-sm hover:shadow-lg transition-all duration-300"
              >
                Start Using Tools
              </a>
              <a
                href="#howitwork"
                className="border-2 px-8 py-2.5 text-center w-full sm:w-auto rounded-full text-lg font-semibold border-blue-600 text-blue-600 transition-all duration-300"
              >
                Learn More
              </a>
            </div>
          ...
          <div
            ...
            className="lg:col-span-2 hidden lg:flex justify-end items-center pr-20"
          >
            <div className="relative">
              {/* Main PDF Document */}
              <div className="w-64 h-80 bg-white rounded-lg shadow-xl transform rotate-3 relative z-20 border border-gray-200">
                <div className="h-8 bg-blue-600 rounded-t-lg flex items-center px-4">
                ...
                <div className="p-4">
                  ...
                  <div className="h-20 bg-blue-100 rounded-lg w-full mb-4 flex items-center justify-center">
                    <svg
              ...
              <div className="absolute -top-4 -right-4 w-12 h-12 bg-sky-500 rounded-full flex items-center justify-center text-white font-bold z-30 shadow-lg">
                PDF
              </div>
              <div className="absolute -bottom-2 -left-6 w-16 h-16 bg-blue-600 rounded-full flex items-center justify-center text-white font-bold z-30 shadow-lg transform rotate-12">
                100%
              </div>
            </div>
          </div>
...
//       <div className="absolute bottom-1/3 left-1/4 w-32 h-32 bg-blue-300/10 rounded-full blur-xl"></div>

//       {/* Small floating circles */}
//       <div className="absolute top-20 right-[20%] w-3 h-3 bg-blue-500/30 rounded-full animate-pulse"></div>
//       <div className="absolute top-40 left-[15%] w-2 h-2 bg-orange-500/30 rounded-full animate-pulse delay-700"></div>
//       <div className="absolute bottom-20 right-[30%] w-4 h-4 bg-blue-400/20 rounded-full animate-pulse delay-1000"></div>
...
//                 href="#howitwork"
//                 whiletap={{ scale: 0.95 }}
//                 className="border-2 border-gray-300 text-gray-700 px-8 py-2.5 text-center w-full sm:w-auto rounded-full text-lg font-semibold hover:border-blue-600 hover:text-blue-600 transition-all duration-300"
//               >
//                 Learn More
//               </motion.a>
//             </motion.div>
