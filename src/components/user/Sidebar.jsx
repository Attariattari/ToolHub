  ...
  const sidebarItems = [
    {
      ...
      items: [
        ...
        { href: "/user/tasks", icon: FaClock, label: "Last tasks" },
        { href: "/user/signatures/signed", icon: FaSignature, label: "Signed" },
    ...
    //   section: "Signatures",
    //   items: [
    //     { href: "/user/signatures", icon: FaFileAlt, label: "Overview" },
    //     { href: "/user/signatures/requests", icon: FaPaperPlane, label: "Sent" },
    //     { href: "/user/signatures/pending", icon: FaInbox, label: "Inbox" },
    //     { href: "/user/signatures/signed", icon: FaSignature, label: "Signed" },
    //     { href: "/user/signatures/templates", icon: FaFileContract, label: "Templates" },
    //     { href: "/user/signatures/contacts", icon: FaAddressBook, label: "Contacts" },
    //     { href: "/user/signatures/settings", icon: FaCog, label: "Settings" },
    //   ],
    // },
    // {
    //   section: "Billing",
  ...
  return (
    <>
      ...
      >
        ...
        <div className="overflow-y-auto custom-scrollbar pb-5 h-full">
          {/* User Profile Section */}
          <div className="px-4 py-6 border-gray-200 pb-1">
            <div className="flex items-center gap-3">
              ...
              <AnimatePresence>
                {!isCollapsed && (
                  ...
                  >
                    <div className="text-blue-600 font-medium text-sm">Dashboard</div>
            ...
            >
              ...
              <div className="p-4 border-b border-gray-200">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-blue-600 font-medium text-sm">Registered</div>
                    <div className="text-gray-800 text-sm">Rashid Ali</div>
                  </div>
                </div>
              </div>
