...
const CustomErrorComponent = ({ errorType, ...otherProps }) => {
  return (
    <div className="w-full h-full bg-blue-50 flex items-center justify-center rounded-lg">
      ...
      <div className="absolute bottom-2 left-2 text-xs text-blue-600 font-semibold">
        Error loading file
      </div>
    </div>
  );
        ...
        <Document
          ...
          error={
            <div className="w-full h-full bg-blue-50 flex items-center justify-center rounded-lg">
              ...
              <div className="absolute bottom-2 left-2 text-xs text-blue-600 font-semibold">PDF</div>
            </div>
          }
        >
          <Page
