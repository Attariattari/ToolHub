      ...
      <div className="flex items-center gap-2">
        <div className="relative">
          <button
            ...
            className="w-6 h-6 bg-blue-500 hover:bg-blue-600 rounded-full flex items-center justify-center transition-all duration-200 shadow-md hover:shadow-lg relative"
          >
        ...
        <div className="text-center">
          ...
          <label className="cursor-pointer">
            <input
              ...
              className="hidden"
            />
            <span className="inline-block bg-white text-blue-600 border border-blue-600 px-4 py-2 rounded hover:bg-blue-50 transition-colors duration-200 text-sm font-medium">
              Select file
            </span>
          </label>
        </div>
  ...
  if (!showFiles && !showUploadArea) {
    return (
      <div className="md:h-[calc(100vh-82px)] bg-gray-50">
          ...
          <div className="max-w-2xl mx-auto">
            ...
            >
              ...
              <label htmlFor="file-upload-main" className="cursor-pointer">
                <div className="inline-block bg-blue-600 hover:bg-blue-700 text-2xl text-white font-semibold py-4 px-24 rounded-xl transition-colors duration-200 mb-4">
                  {uploadButtonText}
                </div>
                <input
                  id="file-upload-main"
        ...
        <footer className="fixed md:absolute bottom-4 right-4 text-sm text-gray-500">
