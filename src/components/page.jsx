...
const ToggleSwitch = ({ enabled, onChange, label, description }) => {
  return (
    <div className="flex items-center justify-between py-3">
      ...
      <div
        className={`w-12 h-6 rounded-full p-1 cursor-pointer transition-all duration-300 ${enabled ? "bg-blue-600" : "bg-gray-300"
          }`}
    ...
    <div className="mb-4">
      ...
      <div className="relative">
        ...
        <input
          ...
          disabled={disabled}
          className={`pl-10 w-full py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 ${disabled ? "bg-gray-50 text-gray-500" : "bg-white"
            }`}
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className={`w-full py-3 px-4 border rounded-lg bg-gray-50 outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 ${errors.newEmail ? "border-blue-500" : "border-gray-300"
                }`}
              placeholder="Enter new email address"
            />
            {errors.newEmail && <p className="text-blue-500 text-sm mt-1">{errors.newEmail}</p>}
          </div>
          ...
          <div className="mb-6">
            ...
            <input
              ...
              className={`w-full py-3 px-4 border rounded-lg bg-gray-50 outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 ${errors.confirmEmail ? "border-blue-500" : "border-gray-300"
                }`}
              placeholder="Re-enter new email address"
            />
            {errors.confirmEmail && <p className="text-blue-500 text-sm mt-1">{errors.confirmEmail}</p>}
          </div>
...
export default function MyAccountPage() {
  ...
  const stats = [
    {
      icon: <FaFileAlt className="text-blue-600" size={24} />,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-7 gap-4">
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
              ...
              <button className="mt-4 sm:mt-0 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-all duration-200 flex items-center gap-2">
                <Check size={16} />
                Save Changes
              </button>
            </div>
            ...
            >
              ...
              <div className="bg-gradient-to-r from-gray-50 to-gray-100 p-6 rounded-lg mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  ...
                  <div className="flex items-center gap-2">
                    <Check className="text-green-600" size={16} />
                    <span className="text-sm text-gray-700">Basic PDFDEX</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Check className="text-green-600" size={16} />
                    <span className="text-sm text-gray-700">
                ...
                <div className="text-sm text-gray-600 mb-4">
                  Upgrade to unlock unlimited processing, advanced tools,
                  priority support, and remove watermarks from your documents.
                </div>
              </div>

              <div className="flex flex-col sm:flex-row gap-3">
                <button className="flex-1 bg-blue-600 hover:bg-blue-700 text-white py-3 px-6 rounded-lg transition-colors font-medium">
          ...
          >
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sticky top-[100px] h-[calc(100vh-120px)]">
              ...
              <div className="text-sm text-gray-600 mb-6">
                Connect your social accounts to easily sign in and share your
                documents across platforms. This helps streamline your workflow
              ...
              <div className="mt-6 p-4 bg-blue-50 rounded-lg">
                ...
                <div className="text-xs text-blue-700">
                  Only connect accounts you trust. You can disconnect any
