// // Modern SVG Icon Components for PDFDEX
// export const MergePDFIcon = ({ className = "w-12 h-12" }) => (
...
//       </linearGradient>
//     </defs>
//     <rect x="2" y="8" width="20" height="26" rx="3" fill="url(#mergeGrad)" opacity="0.9" />
//     <rect x="28" y="16" width="20" height="26" rx="3" fill="url(#mergeGrad)" opacity="0.7" />
//     <path d="M25 25 L35 20 L35 30 Z" fill="#fff" />
//     <circle cx="25" cy="25" r="8" fill="#FF5252" stroke="#fff" strokeWidth="2" />
//     <path d="M21 25 L29 25 M25 21 L25 29" stroke="#fff" strokeWidth="2" strokeLinecap="round" />
//   </svg>
// )

// export const SplitPDFIcon = ({ className = "w-12 h-12" }) => (
//   <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 50 50">
//     <defs>
...
//       </linearGradient>
//     </defs>
//     <rect x="15" y="5" width="20" height="28" rx="3" fill="url(#splitGrad)" />
//     <rect x="5" y="20" width="16" height="20" rx="2" fill="url(#splitGrad)" opacity="0.8" />
//     <rect x="29" y="20" width="16" height="20" rx="2" fill="url(#splitGrad)" opacity="0.8" />
//     <path d="M18 19 L32 19" stroke="#fff" strokeWidth="2" strokeDasharray="3,2" />
//     <path d="M20 16 L15 19 L20 22" fill="none" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
//     <path d="M30 16 L35 19 L30 22" fill="none" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
//   </svg>
// )

// export const CompressPDFIcon = ({ className = "w-12 h-12" }) => (
//   <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 50 50">
//     <defs>
...
//       </linearGradient>
//     </defs>
//     <rect x="8" y="8" width="34" height="34" rx="4" fill="url(#compressGrad)" />
//     <rect x="12" y="12" width="26" height="26" rx="2" fill="#fff" opacity="0.9" />
//     <path d="M25 18 L25 32 M19 26 L25 32 L31 26" fill="none" stroke="url(#compressGrad)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
//     <rect x="19" y="16" width="12" height="2" rx="1" fill="url(#compressGrad)" />
//     <rect x="19" y="34" width="12" height="2" rx="1" fill="url(#compressGrad)" />
//   </svg>
// )

// export const PDFToWordIcon = ({ className = "w-12 h-12" }) => (
//   <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 50 50">
//     <defs>
...
//       </linearGradient>
//     </defs>
//     <rect x="5" y="8" width="18" height="24" rx="2" fill="#FF5252" opacity="0.8" />
//     <rect x="27" y="18" width="18" height="24" rx="2" fill="url(#wordGrad)" />
//     <path d="M18 20 L32 25 L18 30" fill="#fff" />
//     <circle cx="22.5" cy="25" r="6" fill="#fff" stroke="#2196F3" strokeWidth="2" />
//     <path d="M31 25 L35 21 L35 24 L39 24 L39 26 L35 26 L35 29 Z" fill="#fff" />
//     <text x="38" y="37" fontSize="8" fill="#fff" textAnchor="middle">W</text>
//   </svg>
// )

// export const WordToPDFIcon = ({ className = "w-12 h-12" }) => (
//   <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 50 50">
//     <defs>
...
//       </linearGradient>
//     </defs>
//     <rect x="5" y="8" width="18" height="24" rx="2" fill="#2196F3" />
//     <rect x="27" y="18" width="18" height="24" rx="2" fill="url(#pdfGrad)" />
//     <path d="M32 20 L18 25 L32 30" fill="#fff" />
//     <circle cx="27.5" cy="25" r="6" fill="#fff" stroke="#FF5252" strokeWidth="2" />
//     <text x="11" y="27" fontSize="8" fill="#fff" textAnchor="middle">W</text>
//     <text x="38" y="37" fontSize="6" fill="#fff" textAnchor="middle">PDF</text>
//   </svg>
// )

// export const PDFToJPGIcon = ({ className = "w-12 h-12" }) => (
//   <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 50 50">
//     <defs>
...
//     </defs>
//     <rect x="5" y="8" width="18" height="24" rx="2" fill="#FF5252" opacity="0.8" />
//     <rect x="27" y="18" width="18" height="24" rx="2" fill="url(#jpgGrad)" />
//     <path d="M18 20 L32 25 L18 30" fill="#fff" />
//     <circle cx="22.5" cy="25" r="6" fill="#fff" stroke="#FF9800" strokeWidth="2" />
//     <circle cx="34" cy="26" r="3" fill="#fff" />
//     <rect x="30" y="32" width="12" height="6" rx="1" fill="#fff" />
//     <path d="M31 35 L33 33 L35 35 L37 33 L39 35 L41 33" fill="none" stroke="url(#jpgGrad)" strokeWidth="1.5" />
//   </svg>
// )

// export const JPGToPDFIcon = ({ className = "w-12 h-12" }) => (
//   <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 50 50">
//     <rect x="5" y="8" width="18" height="24" rx="2" fill="#FF9800" />
//     <rect x="27" y="18" width="18" height="24" rx="2" fill="#FF5252" />
//     <path d="M32 20 L18 25 L32 30" fill="#fff" />
//     <circle cx="27.5" cy="25" r="6" fill="#fff" stroke="#FF5252" strokeWidth="2" />
//     <circle cx="14" cy="18" r="2" fill="#fff" />
//     <rect x="10" y="24" width="8" height="4" rx="1" fill="#fff" />
//     <text x="38" y="37" fontSize="6" fill="#fff" textAnchor="middle">PDF</text>
//   </svg>
// )

// export const EditPDFIcon = ({ className = "w-12 h-12" }) => (
//   <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 50 50">
//     <defs>
...
//       </linearGradient>
//     </defs>
//     <rect x="8" y="10" width="26" height="32" rx="3" fill="url(#editGrad)" />
//     <rect x="12" y="14" width="18" height="24" rx="1" fill="#fff" opacity="0.9" />
//     <path d="M28 8 L42 8 L38 22 L24 22 Z" fill="#FF9800" />
//     <path d="M30 10 L40 10 L37 17 L27 17 Z" fill="#fff" />
//     <line x1="15" y1="20" x2="25" y2="20" stroke="url(#editGrad)" strokeWidth="1.5" />
//     <line x1="15" y1="24" x2="27" y2="24" stroke="url(#editGrad)" strokeWidth="1.5" />
//     <line x1="15" y1="28" x2="22" y2="28" stroke="url(#editGrad)" strokeWidth="1.5" />
//   </svg>
// )

// export const RotatePDFIcon = ({ className = "w-12 h-12" }) => (
//   <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 50 50">
//     <defs>
...
//       </linearGradient>
//     </defs>
//     <rect x="10" y="10" width="30" height="30" rx="4" fill="url(#rotateGrad)" />
//     <path d="M25 18 A7 7 0 1 1 18 25" fill="none" stroke="#fff" strokeWidth="2.5" strokeLinecap="round" />
//     <path d="M18 18 L22 18 L18 22" fill="#fff" />
//     <rect x="22" y="22" width="8" height="1.5" rx="0.75" fill="#fff" />
//     <rect x="22" y="25" width="10" height="1.5" rx="0.75" fill="#fff" />
//     <rect x="22" y="28" width="6" height="1.5" rx="0.75" fill="#fff" />
//   </svg>
// )

// export const SignPDFIcon = ({ className = "w-12 h-12" }) => (
//   <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 50 50">
//     <defs>
...
//       </linearGradient>
//     </defs>
//     <rect x="8" y="8" width="34" height="34" rx="4" fill="url(#signGrad)" />
//     <rect x="12" y="12" width="26" height="26" rx="2" fill="#fff" />
//     <path d="M16 20 Q20 16 24 20 T32 20" fill="none" stroke="#795548" strokeWidth="2" strokeLinecap="round" />
//     <path d="M18 26 Q22 30 26 26 Q30 22 34 26" fill="none" stroke="#795548" strokeWidth="2" strokeLinecap="round" />
//     <circle cx="40" cy="10" r="6" fill="#FF9800" />
//     <path d="M37 10 L40 7 L43 10 L40 13 Z" fill="#fff" />
//   </svg>
// )

// export const WatermarkIcon = ({ className = "w-12 h-12" }) => (
//   <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 50 50">
//     <defs>
...
//       </linearGradient>
//     </defs>
//     <rect x="8" y="8" width="34" height="34" rx="4" fill="url(#watermarkGrad)" />
//     <rect x="12" y="12" width="26" height="26" rx="2" fill="#fff" opacity="0.9" />
//     <circle cx="25" cy="20" r="4" fill="none" stroke="#00BCD4" strokeWidth="2" opacity="0.5" />
//     <path d="M20 25 L30 25 M20 28 L28 28 M20 31 L26 31" stroke="#00BCD4" strokeWidth="1.5" opacity="0.3" />
//     <path d="M16 16 L34 34" stroke="#00BCD4" strokeWidth="3" opacity="0.2" />
//     <text x="25" y="26" fontSize="8" fill="#00BCD4" textAnchor="middle" opacity="0.4">©</text>
//   </svg>
// )

// export const UnlockPDFIcon = ({ className = "w-12 h-12" }) => (
//   <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 50 50">
//     <defs>
...
//       </linearGradient>
//     </defs>
//     <rect x="8" y="8" width="34" height="34" rx="4" fill="url(#unlockGrad)" />
//     <rect x="16" y="24" width="18" height="12" rx="2" fill="#fff" />
//     <path d="M20 24 L20 18 Q20 14 25 14 Q28 14 28 16" fill="none" stroke="#fff" strokeWidth="2.5" strokeLinecap="round" />
//     <circle cx="25" cy="30" r="2" fill="#4CAF50" />
//     <path d="M25 32 L25 34" stroke="#4CAF50" strokeWidth="2" strokeLinecap="round" />
//     <path d="M32 18 L38 18 M35 15 L35 21" stroke="#4CAF50" strokeWidth="2" strokeLinecap="round" />
//   </svg>
// )

// export const ProtectPDFIcon = ({ className = "w-12 h-12" }) => (
//   <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 50 50">
//     <defs>
...
//       </linearGradient>
//     </defs>
//     <rect x="8" y="8" width="34" height="34" rx="4" fill="url(#protectGrad)" />
//     <path d="M25 12 L31 16 L31 26 Q31 32 25 34 Q19 32 19 26 L19 16 Z" fill="#fff" />
//     <rect x="19" y="24" width="12" height="8" rx="1" fill="#F44336" />
//     <path d="M22 24 L22 20 Q22 18 25 18 Q28 18 28 20 L28 24" fill="none" stroke="#F44336" strokeWidth="2" strokeLinecap="round" />
//     <circle cx="25" cy="28" r="1.5" fill="#fff" />
//   </svg>
// )

// export const OrganizePDFIcon = ({ className = "w-12 h-12" }) => (
//   <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 50 50">
//     <defs>
//       <linearGradient id="organizeGrad" x1="0%" y1="0%" x2="100%" y2="100%">
//         <stop offset="0%" stopColor="#607D8B" />
//         <stop offset="100%" stopColor="#455A64" />
//       </linearGradient>
//     </defs>
//     <rect x="6" y="6" width="12" height="16" rx="2" fill="url(#organizeGrad)" />
//     <rect x="6" y="28" width="12" height="16" rx="2" fill="url(#organizeGrad)" opacity="0.7" />
//     <rect x="32" y="6" width="12" height="16" rx="2" fill="url(#organizeGrad)" opacity="0.8" />
//     <rect x="32" y="28" width="12" height="16" rx="2" fill="url(#organizeGrad)" />
//     <path d="M24 14 L28 18 L24 22" fill="none" stroke="#607D8B" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
//     <path d="M26 36 L22 32 L26 28" fill="none" stroke="#607D8B" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
//     <circle cx="25" cy="25" r="3" fill="#fff" stroke="#607D8B" strokeWidth="2" />
//   </svg>
// )

// export const PDFToPDFAIcon = ({ className = "w-12 h-12" }) => (
//   <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 50 50">
//     <defs>
//       <linearGradient id="pdfaGrad" x1="0%" y1="0%" x2="100%" y2="100%">
//         <stop offset="0%" stopColor="#3F51B5" />
//         <stop offset="100%" stopColor="#303F9F" />
//       </linearGradient>
//     </defs>
//     <rect x="5" y="8" width="18" height="24" rx="2" fill="#FF5252" opacity="0.8" />
//     <rect x="27" y="18" width="18" height="24" rx="2" fill="url(#pdfaGrad)" />
//     <path d="M18 20 L32 25 L18 30" fill="#fff" />
//     <circle cx="22.5" cy="25" r="6" fill="#fff" stroke="#3F51B5" strokeWidth="2" />
//     <text x="38" y="32" fontSize="6" fill="#fff" textAnchor="middle">PDF</text>
//     <text x="38" y="39" fontSize="8" fill="#fff" textAnchor="middle" fontWeight="bold">A</text>
//   </svg>
// )

// export const ExcelToPDFIcon = ({ className = "w-12 h-12" }) => (
//   <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 50 50">
//     <rect x="5" y="8" width="18" height="24" rx="2" fill="#4CAF50" />
//     <rect x="27" y="18" width="18" height="24" rx="2" fill="#FF5252" />
//     <path d="M32 20 L18 25 L32 30" fill="#fff" />
//     <circle cx="27.5" cy="25" r="6" fill="#fff" stroke="#FF5252" strokeWidth="2" />
//     <rect x="8" y="14" width="12" height="8" fill="#fff" opacity="0.9" />
//     <path d="M10 16 L12 18 L10 20 M14 16 L16 18 L14 20 M18 16 L16 18 L18 20" fill="none" stroke="#4CAF50" strokeWidth="1.5" />
//     <text x="38" y="37" fontSize="6" fill="#fff" textAnchor="middle">PDF</text>
//   </svg>
// )

// export const PowerPointToPDFIcon = ({ className = "w-12 h-12" }) => (
//   <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 50 50">
//     <rect x="5" y="8" width="18" height="24" rx="2" fill="#FF5722" />
//     <rect x="27" y="18" width="18" height="24" rx="2" fill="#FF5252" />
//     <path d="M32 20 L18 25 L32 30" fill="#fff" />
//     <circle cx="27.5" cy="25" r="6" fill="#fff" stroke="#FF5252" strokeWidth="2" />
//     <rect x="8" y="14" width="12" height="8" rx="1" fill="#fff" />
//     <circle cx="11" cy="16" r="1" fill="#FF5722" />
//     <rect x="13" y="15" width="5" height="1" fill="#FF5722" />
//     <rect x="13" y="17" width="3" height="1" fill="#FF5722" />
//     <text x="38" y="37" fontSize="6" fill="#fff" textAnchor="middle">PDF</text>
//   </svg>
// )

// export const PDFtoPowerPointIcon = ({ className = "w-12 h-12" }) => (
//   <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 50 50">
//     <rect x="5" y="8" width="18" height="24" rx="2" fill="#FF5252" opacity="0.8" />
//     <rect x="27" y="18" width="18" height="24" rx="2" fill="#FF5722" />
//     <path d="M18 20 L32 25 L18 30" fill="#fff" />
//     <circle cx="22.5" cy="25" r="6" fill="#fff" stroke="#FF5722" strokeWidth="2" />
//     <rect x="30" y="24" width="12" height="8" rx="1" fill="#fff" />
//     <circle cx="33" cy="26" r="1" fill="#FF5722" />
//     <rect x="35" y="25" width="5" height="1" fill="#FF5722" />
//     <rect x="35" y="27" width="3" height="1" fill="#FF5722" />
//     <text x="14" y="26" fontSize="6" fill="#fff" textAnchor="middle">PDF</text>
//   </svg>
// )

// export const PDFtoExcelIcon = ({ className = "w-12 h-12" }) => (
//   <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 50 50">
//     <rect x="5" y="8" width="18" height="24" rx="2" fill="#FF5252" opacity="0.8" />
//     <rect x="27" y="18" width="18" height="24" rx="2" fill="#4CAF50" />
//     <path d="M18 20 L32 25 L18 30" fill="#fff" />
//     <circle cx="22.5" cy="25" r="6" fill="#fff" stroke="#4CAF50" strokeWidth="2" />
//     <rect x="30" y="24" width="12" height="8" fill="#fff" opacity="0.9" />
//     <path d="M32 26 L34 28 L32 30 M36 26 L38 28 L36 30 M40 26 L38 28 L40 30" fill="none" stroke="#4CAF50" strokeWidth="1.5" />
//     <text x="14" y="26" fontSize="6" fill="#fff" textAnchor="middle">PDF</text>
//   </svg>
// )

// export const ScanPDFIcon = ({ className = "w-12 h-12" }) => (
//   <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 50 50">
//     <defs>
...
//       </linearGradient>
//     </defs>
//     <rect x="8" y="8" width="34" height="34" rx="4" fill="url(#scanGrad)" />
//     <rect x="12" y="12" width="26" height="26" rx="2" fill="#fff" />
//     <path d="M8 22 L16 22 M42 22 L34 22" stroke="#009688" strokeWidth="2" strokeLinecap="round" />
//     <path d="M8 28 L16 28 M42 28 L34 28" stroke="#009688" strokeWidth="2" strokeLinecap="round" />
//     <rect x="16" y="16" width="18" height="12" rx="1" fill="#E0F2F1" />
//     <path d="M18 20 L32 20 M18 22 L30 22 M18 24 L28 24" stroke="#009688" strokeWidth="1" />
//     <circle cx="25" cy="32" r="2" fill="#009688" />
//   </svg>
// )

// export const OcrPDFIcon = ({ className = "w-12 h-12" }) => (
//   <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 50 50">
//     <defs>
...
//       </linearGradient>
//     </defs>
//     <rect x="8" y="8" width="34" height="34" rx="4" fill="url(#ocrGrad)" />
//     <rect x="12" y="12" width="26" height="26" rx="2" fill="#fff" />
//     <text x="25" y="22" fontSize="8" fill="#8BC34A" textAnchor="middle" fontWeight="bold">OCR</text>
//     <path d="M16 26 L34 26 M16 29 L32 29 M16 32 L30 32" stroke="#8BC34A" strokeWidth="1.5" />
//     <circle cx="40" cy="12" r="6" fill="#FF9800" />
//     <path d="M37 12 L40 9 L43 12" fill="none" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
//   </svg>
// )

// export const ComparePDFIcon = ({ className = "w-12 h-12" }) => (
//   <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 50 50">
//     <defs>
...
//       </linearGradient>
//     </defs>
//     <rect x="4" y="12" width="16" height="20" rx="2" fill="url(#compareGrad)" opacity="0.8" />
//     <rect x="30" y="18" width="16" height="20" rx="2" fill="url(#compareGrad)" />
//     <circle cx="25" cy="25" r="8" fill="#fff" stroke="url(#compareGrad)" strokeWidth="2" />
//     <path d="M21 25 L24 22 L29 27" fill="none" stroke="url(#compareGrad)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
//     <rect x="7" y="16" width="10" height="1.5" rx="0.75" fill="#fff" />
//     <rect x="7" y="19" width="8" height="1.5" rx="0.75" fill="#fff" />
//     <rect x="33" y="22" width="10" height="1.5" rx="0.75" fill="#fff" />
//     <rect x="33" y="25" width="8" height="1.5" rx="0.75" fill="#fff" />
//   </svg>
// )

// export const RedactPDFIcon = ({ className = "w-12 h-12" }) => (
//   <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 50 50">
//     <defs>
...
//       </linearGradient>
//     </defs>
//     <rect x="8" y="8" width="34" height="34" rx="4" fill="url(#redactGrad)" />
//     <rect x="12" y="12" width="26" height="26" rx="2" fill="#fff" />
//     <rect x="16" y="18" width="18" height="2" rx="1" fill="#424242" />
//     <rect x="16" y="22" width="14" height="2" rx="1" fill="#424242" />
//     <rect x="16" y="26" width="16" height="2" rx="1" fill="#424242" />
//     <rect x="16" y="30" width="12" height="2" rx="1" fill="#424242" />
//     <path d="M35 15 L40 20 L35 25" fill="none" stroke="#FF5252" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
//   </svg>
// )

// export const CropPDFIcon = ({ className = "w-12 h-12" }) => (
//   <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 50 50">
//     <defs>
...
//       </linearGradient>
//     </defs>
//     <rect x="8" y="8" width="34" height="34" rx="4" fill="url(#cropGrad)" />
//     <rect x="14" y="14" width="22" height="22" rx="2" fill="#fff" stroke="url(#cropGrad)" strokeWidth="2" strokeDasharray="3,2" />
//     <path d="M8 8 L16 16 M42 8 L34 16 M8 42 L16 34 M42 42 L34 34" stroke="#fff" strokeWidth="2" strokeLinecap="round" />
//     <rect x="18" y="18" width="14" height="14" fill="#FFF3E0" />
//     <rect x="20" y="22" width="10" height="1.5" rx="0.75" fill="url(#cropGrad)" />
//     <rect x="20" y="25" width="8" height="1.5" rx="0.75" fill="url(#cropGrad)" />
//   </svg>
// )

// export const RepairPDFIcon = ({ className = "w-12 h-12" }) => (
//   <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 50 50">
//     <defs>
...
//       </linearGradient>
//     </defs>
//     <rect x="8" y="8" width="34" height="34" rx="4" fill="url(#repairGrad)" />
//     <rect x="12" y="12" width="26" height="26" rx="2" fill="#fff" />
//     <path d="M32 16 L38 22 L32 28 L26 22 Z" fill="#03A9F4" />
//     <path d="M30 22 L34 18 L34 26 Z" fill="#fff" />
//     <rect x="16" y="18" width="8" height="1.5" rx="0.75" fill="#E1F5FE" />
//     <rect x="16" y="21" width="6" height="1.5" rx="0.75" fill="#E1F5FE" />
//     <rect x="16" y="24" width="7" height="1.5" rx="0.75" fill="#E1F5FE" />
//     <rect x="16" y="30" width="10" height="1.5" rx="0.75" fill="#E1F5FE" />
//     <circle cx="35" cy="35" r="3" fill="#4CAF50" />
//     <path d="M33 35 L34.5 36.5 L37 34" fill="none" stroke="#fff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
//   </svg>
// )

// export const PageNumberIcon = ({ className = "w-12 h-12" }) => (
//   <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 50 50">
//     <defs>
...
//       </linearGradient>
//     </defs>
//     <rect x="6" y="6" width="16" height="20" rx="2" fill="url(#pageGrad)" opacity="0.8" />
//     <rect x="14" y="12" width="16" height="20" rx="2" fill="url(#pageGrad)" opacity="0.9" />
//     <rect x="22" y="18" width="16" height="20" rx="2" fill="url(#pageGrad)" />
//     <circle cx="30" cy="28" r="8" fill="#fff" stroke="url(#pageGrad)" strokeWidth="2" />
//     <text x="30" y="32" fontSize="10" fill="url(#pageGrad)" textAnchor="middle" fontWeight="bold">1</text>
//     <rect x="8" y="10" width="8" height="1" rx="0.5" fill="#fff" />
//     <rect x="8" y="12" width="6" height="1" rx="0.5" fill="#fff" />
//     <rect x="16" y="16" width="8" height="1" rx="0.5" fill="#fff" />
//     <rect x="16" y="18" width="6" height="1" rx="0.5" fill="#fff" />
//   </svg>
// )

// export const HTMLToPDFIcon = ({ className = "w-12 h-12" }) => (
//   <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 50 50">
//     <defs>
...
//       </linearGradient>
//     </defs>
//     <rect x="5" y="8" width="18" height="24" rx="2" fill="url(#htmlGrad)" />
//     <rect x="27" y="18" width="18" height="24" rx="2" fill="#FF5252" />
//     <path d="M32 20 L18 25 L32 30" fill="#fff" />
//     <circle cx="27.5" cy="25" r="6" fill="#fff" stroke="#FF5252" strokeWidth="2" />
//     <path d="M8 16 L10 16 L12 18 L10 20 L8 20 M16 16 L18 16 L20 18 L18 20 L16 20" fill="none" stroke="#fff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
//     <text x="14" y="27" fontSize="4" fill="#fff" textAnchor="middle">HTML</text>
//     <text x="38" y="37" fontSize="6" fill="#fff" textAnchor="middle">PDF</text>
//   </svg>
// )

// export const PowerPintToPDFIcon = ({ className = "w-12 h-12" }) => (
//   <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 50 50"><path d="M17.676 34.344h9.55c2.476 0 3.375-.258 4.28-.742a5.04 5.04 0 0 0 2.097-2.102c.495-.902.743-1.8.743-4.277v-9.547H44.82c1.8 0 2.453.187 3.114.54.656.355 1.175.87 1.527 1.527s.54 1.31.54 3.113V44.82c0 1.8-.187 2.453-.54 3.114-.35.656-.87 1.175-1.526 1.527S46.62 50 44.82 50H22.855c-1.8 0-2.453-.187-3.113-.54s-1.172-.87-1.527-1.526-.54-1.312-.54-3.113zm0 0" fillRule="evenodd" fill="rgb(100%,46.27451%,31.764706%)"></path><path d="M43.94 37.137c0-.477-.393-.864-.88-.864s-.884.387-.884.864v3.843l-5.146-5.046c-.346-.34-.9-.34-1.25 0-.163.16-.257.38-.257.61a.86.86 0 0 0 .258.613l5.145 5.05h-3.914c-.49 0-.882.387-.882.867s.393.867.882.867H43.063c.113-.002.227-.022.335-.07.215-.085.387-.253.477-.464a.75.75 0 0 0 .065-.332l.005-5.934zm0 0" fill="rgb(100%,100%,100%)"></path><g fillRule="evenodd"><path d="M27.145 32.324H5.18c-1.8 0-2.453-.187-3.113-.543S.89 30.914.54 30.254 0 28.95 0 27.145V5.18c0-1.8.188-2.453.54-3.113A3.69 3.69 0 0 1 2.066.539C2.727.188 3.38 0 5.18 0h21.965c1.8 0 2.453.188 3.113.54s1.172.87 1.527 1.527.54 1.313.54 3.113v21.965c0 1.8-.187 2.453-.54 3.113s-.87 1.176-1.527 1.527-1.312.54-3.113.54zm0 0" fill="rgb(95.294118%,85.098039%,80%)"></path><path d="M19.367 17.156c-1.086.898-2.54 1.348-4.36 1.348H13.39V23.5H10V9h5.313C19.102 9 21 10.54 21 13.62c0 1.453-.543 2.637-1.633 3.535zM14.82 11.5H13.5V16h1.32c1.785 0 2.68-.758 2.68-2.273 0-1.484-.89-2.227-2.68-2.227zm0 0" fill="rgb(81.568627%,27.058824%,14.901961%)"></path></g></svg>
// )


// SVG Icon Components for PDFDEX
export const MergePDFIcon = ({ className = "w-12 h-12" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 50 50">
...
export const EditPDFIcon = ({ className = "w-12 h-12" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 100 100" fillRule="evenodd">
    <path
      d="M16.024 0h67.95c5.572 0 7.593.58 9.63 1.67s3.636 2.688 4.725 4.725s1.67 4.058 1.67 9.63v67.95c0 5.572-.58 7.593-1.67 9.63s-2.688 3.636-4.725 4.725-4.058 1.67-9.63 1.67h-67.95c-5.572 0-7.593-.58-9.63-1.67S2.76 95.642 1.67 93.605 0 89.548 0 83.976v-67.95c0-5.572.58-7.593 1.67-9.63S4.358 2.76 6.395 1.67 10.452 0 16.024 0z"
      fill="#ab6993"
    />
    <path
...
export const PDFtoPowerPointIcon = ({ className = "w-12 h-12" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 50 50"><path d="M32.324 15.656h-9.55c-2.477 0-3.375.258-4.28.742a5.06 5.06 0 0 0-2.098 2.102c-.484.902-.742 1.8-.742 4.277v9.55H5.18c-1.8 0-2.453-.187-3.113-.54a3.69 3.69 0 0 1-1.527-1.527C.188 29.598 0 28.945 0 27.145V5.18c0-1.8.188-2.453.54-3.113A3.69 3.69 0 0 1 2.066.539C2.727.188 3.38 0 5.18 0h21.965c1.8 0 2.453.188 3.113.54a3.69 3.69 0 0 1 1.527 1.527c.352.66.54 1.313.54 3.113zm0 0" fillRule="evenodd" fill="rgb(95.294118%,85.098039%,80%)"></path><path d="M14.477 7.52c0-.477-.395-.863-.883-.863s-.883.387-.883.863v3.844L7.566 6.316a.89.89 0 0 0-1.246 0c-.168.16-.258.38-.258.61s.1.453.258.613l5.145 5.05H7.55c-.488 0-.883.387-.883.867s.395.863.883.863h6.047a.85.85 0 0 0 .34-.066c.215-.086.387-.254.477-.47.05-.102.066-.215.066-.328l.004-5.934zm0 0" fill="rgb(81.568627%,27.058824%,14.901961%)"></path><g fillRule="evenodd"><path d="M22.855 17.676H44.82c1.8 0 2.453.188 3.113.543.648.344 1.184.875 1.527 1.527.352.656.54 1.31.54 3.11V44.82c0 1.8-.187 2.453-.54 3.113a3.69 3.69 0 0 1-1.527 1.527c-.66.352-1.312.54-3.113.54H22.855c-1.8 0-2.453-.187-3.113-.54-.648-.344-1.18-.88-1.527-1.527-.352-.66-.54-1.312-.54-3.113V22.855c0-1.8.188-2.453.54-3.113.348-.648.88-1.18 1.527-1.527.66-.352 1.313-.54 3.113-.54zm0 0" fill="rgb(100%,46.27451%,31.764706%)"></path><path d="M38.367 34.648C37.28 35.55 35.828 36 34.008 36H32.39v5H29V26.5h5.313c3.79 0 5.688 1.54 5.688 4.62 0 1.453-.543 2.633-1.633 3.535zM33.82 29H32.5v4.5h1.32c1.785 0 2.68-.758 2.68-2.273 0-1.484-.89-2.227-2.68-2.227zm0 0" fill="rgb(100%,100%,100%)"></path></g></svg>
)
