      ...
      <div className="flex-1 flex items-center justify-center p-8">
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            <button className="flex items-center justify-center px-4 py-3 border border-gray-300 bg-gray-50 rounded-lg hover:bg-white transition-colors">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col justify-center items-center text-white p-12">
          <div className="text-center">
            <h2 className="text-4xl font-bold mb-6">Welcome to PDF ToolsHub</h2>
            <p className="text-xl text-red-100 mb-8 leading-relaxed">
              Access powerful PDF tools to merge, split, compress, and convert your documents with ease.
            </p>
            ...
            <div className="space-y-4 text-left">
              <div className="flex items-center">
                ...
                <span className="text-red-100">Free PDF tools for everyone</span>
              </div>
              <div className="flex items-center">
                <div className="w-8 h-8 bg-white bg-opacity-20 rounded-full flex items-center justify-center mr-4">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span className="text-red-100">Secure and private processing</span>
              </div>
              <div className="flex items-center">
                <div className="w-8 h-8 bg-white bg-opacity-20 rounded-full flex items-center justify-center mr-4">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span className="text-red-100">No software installation required</span>
              </div>
            </div>
          </div>
        </div>
