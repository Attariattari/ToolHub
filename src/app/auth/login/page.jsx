  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.twoFactorRequired) {
        ...
        // Navigate to two-factor page with email as query parameter
        router.push(`/auth/verify-email?email=${encodeURIComponent(data.email)}&purpose=two_factor_auth`)
        return
      }
      ...
      if (status === 403) {
        // Account verification or activation issues
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            ...
            {/* <button
              disabled={isLoading}
              className="flex items-center justify-center px-4 py-3 border border-gray-300 bg-gray-50 rounded-lg hover:bg-white transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link
                ...
                className={`text-sm text-blue-600 hover:text-blue-700 ${isLoading ? 'pointer-events-none opacity-50' : ''}`}
              >
                Forgot password?
              </Link>
            </div>
