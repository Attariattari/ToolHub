...
import { FiEye, FiEyeOff, FiLock, FiArrowRight, FiCheck, FiLoader } from "react-icons/fi"
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (errorMessage.includes('Invalid reset code')) {
        setErrors({ general: "Invalid reset code. Please request a new password reset." })
      } else if (errorMessage.includes('expired')) {
        setErrors({ general: "Reset code has expired. Please request a new password reset." })
      } else {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-orange-50 flex items-center justify-center">
        <div className="text-center">
          <FiLoader className="animate-spin w-8 h-8 text-blue-600 mx-auto mb-4" />
          ...
          {!isSubmitted ? (
            <>
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-sm text-gray-500 mt-2">Resetting password for: <strong>{email}</strong></p>
              </div>
              ...
              {errors.general && (
                <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                  ...
                  <Link href="/auth/forgot-password" className="text-blue-600 hover:text-blue-700 text-sm underline mt-2 inline-block">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-10 pr-12 py-3 bg-gray-50 border-0 ring-1 rounded-lg outline-none transition-colors ${errors.password ? 'ring-blue-500' : 'ring-gray-300 focus:ring-2 focus:ring-blue-500'
                        }`}
                    ...
                    <div className="space-y-2">
                      {passwordRequirements.map((req, index) => (
                        <div key={index} className="flex items-center">
                          <div
                            className={`w-4 h-4 rounded-full flex items-center justify-center mr-3 transition-colors ${req.met ? "bg-green-500" : "bg-gray-300"
                              }`}
                          >
                            {req.met && <FiCheck className="w-3 h-3 text-white" />}
                          </div>
                          <span className={`text-sm transition-colors ${req.met ? "text-green-600" : "text-gray-500"}`}>
                            {req.text}
                          </span>
                        </div>
                      ))}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className={`w-full pl-10 pr-12 py-3 bg-gray-50 border-0 ring-1 rounded-lg outline-none transition-colors ${errors.confirmPassword ? 'ring-blue-500' : 'ring-gray-300 focus:ring-2 focus:ring-blue-500'
                        }`}
                  ...
                  {formData.confirmPassword && formData.password !== formData.confirmPassword && !errors.confirmPassword && (
                    <p className="mt-1 text-sm text-blue-600">Passwords do not match</p>
                  )}
                </div>
                ...
                <motion.button
                  ...
                  className={`w-full py-3 px-4 rounded-lg font-medium transition-all duration-300 flex items-center justify-center ${!isFormValid || isLoading
          ...
          <div className="text-center">
            ...
            <div className="space-y-4 text-left">
              <div className="flex items-center">
                ...
                <span className="text-blue-100">Advanced encryption protection</span>
              </div>
              <div className="flex items-center">
                <div className="w-8 h-8 bg-white bg-opacity-20 rounded-full flex items-center justify-center mr-4">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span className="text-blue-100">Secure password requirements</span>
              </div>
              <div className="flex items-center">
                <div className="w-8 h-8 bg-white bg-opacity-20 rounded-full flex items-center justify-center mr-4">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span className="text-blue-100">Account security guaranteed</span>
              </div>
              <div className="flex items-center">
                <div className="w-8 h-8 bg-white bg-opacity-20 rounded-full flex items-center justify-center mr-4">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span className="text-blue-100">Automatic security cleanup</span>
              </div>
            </div>
          </div>
        </div>
...
//                       value={formData.password}
//                       onChange={handleInputChange}
//                       className="w-full pl-10 pr-12 py-3 bg-gray-50 border-0 ring-1 ring-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none transition-colors"
//                       placeholder="Enter new password"
//                       required
//                     />
//                     <button
