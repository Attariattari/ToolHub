            ...
            <div className="space-y-4 mb-6">
              ...
              >
                <div className="flex items-start gap-3">
                  <div className="flex-shrink-0 mt-1">
                    <div
                      className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${conversionMode === "pages"
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600">
                      ...
                      {estimatedJPGCount} JPG will be created.
                    </p>
                  </div>
                </div>
              </div>
              ...
              >
                <div className="flex items-start gap-3">
                  <div className="flex-shrink-0 mt-1">
                    <div
                      className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${conversionMode === "images"
                          ? "border-red-500 bg-red-500"
                          : "border-gray-300"
                        }`}
                    >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600">
                      All embedded images inside the PDF will be extracted as
                      JPG images.
                    </p>
                  </div>
                </div>
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600">
                        Every page of this PDF will be converted into a JPG
                        file. {estimatedJPGCount} JPG will be created.
                      </p>
                    </div>
                  </div>
                </div>
