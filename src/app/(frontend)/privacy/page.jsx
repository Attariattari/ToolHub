        ...
        >
          <div>
            ...
            <div className="prose prose-lg max-w-none text-gray-600">
              <p>
                At PDFDEX, we take your privacy seriously. This Privacy Policy explains how we collect, use,
              ...
              <p>
                When you use our PDFDEX, you may upload documents to our service. We want to be clear about how we
                handle this data:
              </p>
              <ul className="list-disc pl-6 mb-4">
                <li>
              ...
              <p>PDFDEX may use the information we collect from you for various purposes:</p>
              <ul className="list-disc pl-6 mb-4">
              ...
              <p>
                ...
                <a href="mailto:privacy@pdfdex.com" className="text-blue-600 hover:underline">
                  privacy@pdfdex.com
                </a>
                .
              </p>
