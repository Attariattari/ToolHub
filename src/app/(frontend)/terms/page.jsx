        ...
        >
          <div>
            ...
            <div className="prose prose-lg max-w-none text-gray-600">
              <p>
                Welcome to PDFDEX. Please read these Terms of Service ("Terms", "Terms of Service") carefully
                before using the PDFDEX website and PDF processing tools (the "Service") operated by PDFDEX
                ("us", "we", or "our").
              </p>
              <p>
              ...
              <p>
                PDFDEX provides various tools for processing PDF documents. By using our Service, you agree to:
              </p>
              ...
              <p>
                ...
                property of PDFDEX and its licensors. The Service is protected by copyright, trademark, and other
                laws of both the United States and foreign countries. Our trademarks and trade dress may not be used in
                connection with any product or service without the prior written consent of PDFDEX.
              </p>
              <p>
              ...
              <p>
                ...
                login providers. By using these integrations, you authorize PDFDEX to access and interact with
              ...
              <p>
                ...
                acknowledge and agree that PDFDEX shall not be responsible or liable, directly or indirectly, for
              ...
              <p>
                PDFDEX offers both free and premium (paid) services. The features and limitations of each service
              ...
              <p>
                In no event shall PDFDEX, nor its directors, employees, partners, agents, suppliers, or
              ...
              <p>
                PDFDEX does not warrant that a) the Service will function uninterrupted, secure, or available at
              ...
              <p>
                ...
                <a href="mailto:legal@pdfdex.com" className="text-blue-600 hover:underline">
                  legal@pdfdex.com
                </a>
                .
              </p>
