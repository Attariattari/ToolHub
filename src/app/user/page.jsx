    ...
    <div className="mb-4">
      ...
      <div className="relative">
        ...
        <input
          ...
          disabled={disabled}
          className={`pl-10 outline-none w-full py-3 border border-gray-300 rounded-lg focus:ring-1 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 ${
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className={`w-full py-3 px-4 border rounded-lg bg-gray-50 outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 ${
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className={`w-full py-3 px-4 pr-12 border rounded-lg bg-gray-50 outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 ${
...
export default function MyAccountPage() {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto min-h-[calc(100vh-84px)]">
      <motion.div
...
//   return (
//     <div className="p-6 max-w-7xl mx-auto h-[calc(100vh-84px)]">
//       <motion.div
//         initial={{ opacity: 0, y: 20 }}
//         animate={{ opacity: 1, y: 0 }}
//         transition={{ duration: 0.5 }}
