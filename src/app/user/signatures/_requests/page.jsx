...
export default function SignaturesRequestsPage() {
...
//     recipientName: "Aslam Khan",
//     createdAt: "2025-06-10T09:40:10Z",
//     signedAt: null,
//     status: "pending",
//     size: "2.2 MB",
//   },
...
//     createdAt: "2025-05-28T15:05:00Z",
//     signedAt: null,
//     status: "declined",
//     size: "1.1 MB",
//   },
...
//     return `${yyyy}-${mm}-${dd}`
//   })
//   const [tmpStatuses, setTmpStatuses] = useState({}) // { signed: true, ... }
...
//                           <div className="text-sm text-green-600">
//                             Signed on {new Date(row.signedAt).toLocaleDateString("en-US", { year: "numeric", month: "2-digit", day: "2-digit" })}
//                           </div>
//                         )}
//                       </td>
//                       <td className="px-6 py-4 whitespace-nowrap">
