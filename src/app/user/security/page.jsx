          ...
          <div className="mb-4">
            ...
            <div className="relative">
              <input
                ...
                className={`w-full py-3 px-4 pr-12 border rounded-lg bg-gray-50 outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 ${errors.currentPassword ? "border-blue-500" : "border-gray-300"
                  }`}
            ...
            {errors.currentPassword && <p className="text-blue-500 text-sm mt-1">{errors.currentPassword}</p>}
          </div>
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              <input
                ...
                className={`w-full py-3 px-4 pr-12 border rounded-lg bg-gray-50 outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 ${errors.newPassword ? "border-blue-500" : "border-gray-300"
                  }`}
            ...
            {errors.newPassword && <p className="text-blue-500 text-sm mt-1">{errors.newPassword}</p>}
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="relative">
              <input
                ...
                className={`w-full py-3 px-4 pr-12 border rounded-lg bg-gray-50 outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 ${errors.confirmPassword ? "border-blue-500" : "border-gray-300"
                  }`}
            ...
            {errors.confirmPassword && <p className="text-blue-500 text-sm mt-1">{errors.confirmPassword}</p>}
          </div>
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              <div className="flex items-center justify-between mb-2">
                ...
                <button
                  ...
                  className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 whitespace-nowrap rounded-lg transition-colors font-medium"
                >
                  Change Password
                </button>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="border border-gray-200 rounded-lg p-4">
                <div className="flex items-center justify-between py-4">
                  ...
                  <div
                    className={`w-12 h-6 rounded-full p-1 cursor-pointer transition-all duration-300 ${authenticatorEnabled ? "bg-blue-600" : "bg-gray-300"
                      }`}
                    onClick={() => {
              ...
              {activeSessions.map((session, index) => (
                <div key={index} className="bg-gray-50 p-4 rounded-lg">
                  <div className="flex justify-between items-start">
                    ...
                    {!session.current && (
                      <button className="text-blue-600 hover:text-blue-700 text-sm font-medium">Sign Out</button>
                    )}
                  </div>
                </div>
              ))}
